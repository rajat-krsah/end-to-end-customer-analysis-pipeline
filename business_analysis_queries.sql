...
subscription_status, ROUND(AVG(purchase_amount),2) AS average_spend, 
...
ROUND(COUNT(item_purchased) FILTER(WHERE discount_applied = 'Yes')*100.0/COUNT(item_purchased),2) 
AS discount_rate
FROM customer
GROUP BY item_purchased
